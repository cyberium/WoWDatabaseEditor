...
public class CMWrathMySqlDatabaseProvider : BaseCMMySqlDatabaseProvider<CMaNGOSWrathDatabase>
{
    public CMWrathMySqlDatabaseProvider(IWorldDatabaseSettingsProvider settings, IAuthDatabaseSettingsProvider authSettings, DatabaseLogger databaseLogger, ICurrentCoreVersion currentCoreVersion) : base(settings, authSettings, databaseLogger, currentCoreVersion)
    {
    }
    ...
    protected override async Task SetCreatureTemplateAI(CMaNGOSWrathDatabase model, uint entry, string ainame, string scriptname)
    {
    ...
    protected override async Task<ICreature?> GetCreatureByGuid(CMaNGOSWrathDatabase model, uint guid)
    {
    ...
    protected override Task<IGameObject?> GetGameObjectByGuidAsync(CMaNGOSWrathDatabase model, uint guid)
    {
