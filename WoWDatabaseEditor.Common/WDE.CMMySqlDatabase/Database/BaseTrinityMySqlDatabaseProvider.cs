...
{
    public abstract class BaseCMMySqlDatabaseProvider<T> : IAsyncDatabaseProvider, IAuthDatabaseProvider where T : BaseCMDatabase, new()
    {
        ...
        public BaseCMMySqlDatabaseProvider(IWorldDatabaseSettingsProvider settings,
