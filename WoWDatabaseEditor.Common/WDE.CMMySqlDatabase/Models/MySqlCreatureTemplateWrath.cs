...
namespace WDE.CMMySqlDatabase.Models
{
    ...
    public class MySqlCreatureTemplateWrath : ICreatureTemplate
    {
		...
		[Column("MinLevel"                                    )] public byte    MinLevel               { get; set; } // tinyint(3) unsigned
		[Column("MaxLevel"                                    )] public byte    MaxLevel               { get; set; } // tinyint(3) unsigned
		...
		[Column("Family"                                      )] public sbyte   Family                 { get; set; } // tinyint(4)
		[Column("CreatureType"                                )] public byte    CreatureType           { get; set; } // tinyint(3) unsigned
		[Column("InhabitType"                                 )] public byte    InhabitType            { get; set; } // tinyint(3) unsigned
		[Column("RegenerateStats"                             )] public byte    RegenerateStats        { get; set; } // tinyint(3) unsigned
		[Column("RacialLeader"                                )] public byte    RacialLeader           { get; set; } // tinyint(3) unsigned
		...
		[Column("UnitFlags2"                                  )] public uint    UnitFlags2             { get; set; } // int(10) unsigned
		[Column("DynamicFlags"                                )] public uint    DynamicFlags           { get; set; } // int(10) unsigned
		[Column("ExtraFlags"                                  )] public uint    ExtraFlags             { get; set; } // int(10) unsigned
		[Column("CreatureTypeFlags"                           )] public uint    CreatureTypeFlags      { get; set; } // int(10) unsigned
		...
		[Column("Expansion"                                   )] public sbyte   Expansion              { get; set; } // tinyint(3)
		[Column("HealthMultiplier"                            )] public float   HealthMultiplier       { get; set; } // float
		[Column("PowerMultiplier"                             )] public float   PowerMultiplier        { get; set; } // float
		...
		[Column("MovementTemplateId"                          )] public uint    MovementTemplateId     { get; set; } // int(11) unsigned
